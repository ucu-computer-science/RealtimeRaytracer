...
//    Sphere sphere3{{7, 7, -4}, 6, Color::hotpink()};
//    Sphere sphere4{{7, -5, -7}, 3, Color::pink()};
//    sphere1.setMaterial(Material({}, 1, 1, 2, 0.3));
//    sphere2.setMaterial(Material({}, 1, 1, 10, 0.3));
//    sphere3.setMaterial(Material({}, 1, 1, 50, 0.3));
//    sphere4.setMaterial(Material({}, 1, 1, 250, 0.3));
////    plane4.setMaterial(Material({}, 1, 0, 1000, 0));
////
////    sphere2.setReflection(.3f);
////    sphere3.setReflection(.3f);
////    sphere4.setReflection(.3f);
...
//               6.6f};
//    Sphere sphere1{
//            {-4, 2, -5}, 5, Color::skyBlue()};
////    sphere1.setReflection(0.7f);
//    cube1.setColor(Color::skyBlue());
//
//    cube1.setMaterial({{}, 1, 1, 250, 0.5});
//    sphere1.setMaterial({{}, 1, 1, 250, .5});

    Camera camera{{0, -28, -5}, fov, glm::vec2((float) width / (float) height, 1)};
//    GlobalLight light8{{0, 0, 1}, Color::white(), 1};
//    GlobalLight lighczxct8{{0, 0, -1}, Color::white(), 1};
//
//    PointLight light3{
//            {-10, 0, 0}, {255 / 255.0f, 236 / 255.0f, 156 / 255.0f}, FLT_MAX, 1};
//    PointLight light3{
//            {-100, 0, 0}, Color::skyBlue(), FLT_MAX, 1};
//    PointLight light4{
//            {0, 100, 0}, Color::skyBlue(), FLT_MAX, 1};
        GlobalLight lighczxct8{{0, 1, 0}, Color::white(), 1};

//    PointLight light4{
//            {0, 10, 1}, {255 / 255.0f, 236 / 255.0f, 156 / 255.0f}, FLT_MAX, 1};
//    Plane plane1{{-100, 0, 0}, {1, 0, 1}, Color::skyBlue()};
//    Plane plane2{{0, -100, 0}, {0, 1, 1}, Color::skyBlue()};
//    Plane plane3{{100, 0, 0}, {-1, 0, 1}, Color::skyBlue()};
//    Plane plane45{{0, 100, 0}, {0, -1, 1}, Color::skyBlue()};
//    Plane plane4{{0, 0, -10}, {0, 0, 1}, Color::white()};
//    plane4.setReflection(0.3);
//    Plane plane4{{-4, 2, -5}, {0, 0, 1}, Color::white()};
//    plane4.setReflection(0.9);
//    plane4.setColor(Color::white());

//    Sphere sphere1{
//            {-4, 2, -5}, 5, Color{100.f / 100.f, 49.8f / 100.f, 31.4f / 100.f}};
//    Sphere sphere2{{-6, -10, -4}, 1, Color::gold()};
    Sphere sphere3{{-6, -30, -4}, 6, Color::hotpink()};
//    Sphere sphere4{{7, -5, -7}, 3, Color::pink()};
//    Cube cube1{glm::vec3{4, -4, -6.7},
//               {{0 * DEG_TO_RAD, 0 * DEG_TO_RAD, -28 * DEG_TO_RAD}},
//               6.6f};
//    sphere1.setTexture("./marble.jpg");
    sphere3.setTexture("./beer.png");
//    sphere2.setTexture("./moon.jpg");
//    sphere1.setReflection(.3f);
//    sphere2.setReflection(.3f);
//    sphere3.setReflection(.3f);
//    sphere4.setReflection(.3f);
...
//    sphere2.setMaterial({{}, 1, .1, 1000, .3});
//    sphere3.setMaterial({{}, 1, .51, 1000, .5});
//    sphere4.setMaterial({{}, 1, 1, 1000, .7});
//    plane6.setMaterial({{}, 1, 0, 0, 1});
//    plane1.setMaterial({{}, 1, 0, 0, 1});
//    plane2.setMaterial({{}, 1, 10000, 1});
//    plane3.setMaterial({{}, 1, 0, 0, 1});
//    plane4.setMaterial({{}, 1, 0, 0, 1});
//    plane5.setMaterial({{}, 1, 0, 0, 1});
//    plane6.setMaterial({{}, 1, 0, 0, 1});
//    cube1.setReflection(0.3f);
...
////
////    ColorTexture texture(filename);
////    for (auto &el: texture.bitmap) {
////        std::cout << texture.getColor(0.f,0.f) << std::endl;
////    }
////    for (int y = 0; y < texture.height; ++y) {
////        for (int x = 0; x < texture.width; ++x) {
////            std::cout << texture.getColor(x, y) << std::endl;
////            size_t index = (y * texture.width + x);
