...
//	Camera camera{{0, -28, 3}, fov, glm::vec2((float)width / (float)height, 1)};
//        PointLight light3{{0, 0, 8}, {255 / 255.0f, 236 / 255.0f, 156 / 255.0f}, 20, 1};
//        Light light6{{0, 0, 8}, {1,1,1}, FLT_MAX, 0.4, {0, 0, 0}, {1, 1, 1}};

//        Light light6{{0, -8, 14}, {255 / 255.0f, 236 / 255.0f, 156 / 255.0f}, FLT_MAX, 1.5, {5, 5, 0}, {10, 10, 1}};
