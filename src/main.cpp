...
int main(int argv, char* args[])
{
	...
	Camera camera{{0, -98, 3}, fov, glm::vec2((float)width / (float)height, 1)};
//        PointLight light3{{0, 0, 8}, {255 / 255.0f, 236 / 255.0f, 156 / 255.0f}, 50, 1};
//        Light light6{{0, 0, 8}, {1,1,1}, 50, 0.4, {5, 5, 0}, {10, 10, 1}};
        GlobalLight light8{{0.1, 0.2, 1}, Color::white(), 1};
...
//	Plane plane3{{0, 0, 10}, {0, 0, -1}, Color::white()};
	Plane plane4{{0, 0, -10}, {0, 0, 1}, Color::blue()};
