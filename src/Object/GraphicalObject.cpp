...
GraphicalObject::GraphicalObject(glm::vec3 pos, glm::quat rot, Material material, std::string texturePath)
        : Object(pos, rot), material{material}, texture{texturePath}{
...
Cube::Cube(glm::vec3 pos, glm::quat rot, float side)
        : GraphicalObject(pos, rot) {
